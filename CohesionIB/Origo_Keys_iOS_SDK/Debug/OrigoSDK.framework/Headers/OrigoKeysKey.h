 ...
 */
@interface OrigoKeysKey : NSObject
...
/**
* Get the suffix of this key owner
*
* @return The suffix of this key owner, or nil if no title was provided when the key was issued.
*/
- (NSString *)suffix;
/**
* Get the name of this key owner
*
* @return The name  of this key owner, or nil if no name was provided when the key was issued.
*/
- (NSString *)name;
/**
* Get the accessToken title of this key
*
* @return The accessToken  of this key
*/
