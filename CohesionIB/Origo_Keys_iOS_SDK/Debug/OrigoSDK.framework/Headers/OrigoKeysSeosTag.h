...
/**
 * Represents a Seos Tag. Use this class in conjunction with MobleKeysGetDataApduCommand and OrigoKeysPutDataApduCommand
 ...
 */
@interface OrigoKeysSeosTag : NSObject
