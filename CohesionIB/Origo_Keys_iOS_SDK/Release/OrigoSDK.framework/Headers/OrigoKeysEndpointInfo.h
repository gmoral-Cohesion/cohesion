...
typedef NS_ENUM(NSInteger, OrigoEnvironmentType) {
    ...
    OrigoEnvironmentStaging = 5,
    OrigoEnvironmentDev = 3,
    OrigoEnvironmentTest = 2,
    OrigoEnvironmentDemo = 1,
    OrigoEnvironmentProd = 0,
    OrigoEnvironmentLocal= 4,
    OrigoEnvironmentAcceptance=6
};
